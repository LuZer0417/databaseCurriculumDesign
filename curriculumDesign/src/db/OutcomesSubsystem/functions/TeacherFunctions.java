...
public class TeacherFunctions {
    ...
    //成果初审
    public static void resultFirCensor() throws Exception {
        System.out.println("**********成果初审界面**********");
        System.out.print("请输入你要通过的成果id：");
        Scanner sc = new Scanner(System.in);
        String RNO = sc.nextLine();
        DAOFactory.getInstance().getResultDAO().updateFirCensor(RNO);
        System.out.println("**********初审更改成功**********");
    }
}
